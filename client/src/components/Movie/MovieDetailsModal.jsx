        ...
        <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-[420px] sm:max-w-[600px] lg:max-w-[984px] p-4 max-h-[90vh] overflow-auto">
          <div className="bg-white text-black shadow-md dark:bg-[#12141D] dark:text-white rounded-2xl sm:grid sm:grid-cols-[2fr_1fr] overflow-hidden">
            ...
            <div className="p-5 lg:p-11">
              <div className>
                <h2 className="text-3xl text-[#9fa0a4] dark:text-[#575A6E] lg:text-[50px] mb-2 font-bold">
                  {movie.title}
                </h2>
              ...
              <p className="text-sm text-[#9fa0a4] dark:text-[#575A6E] lg:text-base mb-8 lg:mb-16">
                {movie.description}
              </p>
